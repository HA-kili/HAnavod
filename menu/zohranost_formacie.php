                ...
                <div class="section-name"> Zohranosť formácie </div>
                    ...
                    <br><br> 
                    Pri výmene hráča vo formácii sa jej zohranosť zníži o 25%, takže po výmene 4 hráčov ostane vo formácii iba jeden z pôvodného zloženia a zohranosť formácie bude 0%. <a class="novinka" href="https://www.hockeyarena.net/sk/index.php?p=public_ha_news.php&id=7926"><img class="icons" src="./icons/novinka.png"></a>
                    Formácia s náhradníkom sa zohráva o 25% pomalšie za každého náhradníka. <a class="novinka" href="https://www.hockeyarena.net/sk/index.php?p=public_ha_news.php&id=7957"><img class="icons" src="./icons/novinka.png"></a>
                    <br><br>
