                ...
                <div class="section-name"> U23 mužstvo </div>
                    ...
                    <ul>
                        ...
                        <li> hráč, ktorý ešte nemá alebo už nemá sezónne štatistiky zapísané v aktuálne končiacej sezóne pôjde presunúť z main do U23 aj v ten posledný piatok/sobota - <a class="navod" href="./images/main_u23.png">info</a>. </li> 
                        <li> nie je možné presúvať hráčov, ktorí sú na trhu </li>
                        ...
                        <li> 23 ročných hráčov je možné presunúť do hlavného mužstva v poslednú sobotu do konca prepočtu (cca 22:10), potom sa už systém postará o ich automatický presun - viď bod 12.  </li>
                    </ul>
                    <br>
                    5. Spoločný maximálny limit počtu hráčov je 64, ten istý limit bude platiť aj pre hlavné
                        mužstvo, ktoré nemá U23 mužstvo. Minimálny limit hráčov je 20 platný samostatne pre HLAVNÉ aj U23 mužstvo. 
                    <br><br> 
