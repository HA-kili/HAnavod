                ...
                <div class="section-name"> Postup nastavenia formácií a náhradníkov </div>
                    ...
                    Potom im treba – podobne ako pri brankároch – určiť priority. Aj napriek tomu že môžete mať vytvorených až 20 formácií, na zápas nastúpia najviac 4 s najvyššou prioritou.
                    ...
                    “Pridať“ v príslušnej časti. Podobným spôsobom ako brankára je zo zoznamu hráčov možné vybrať maximálne 12 náhradníkov každého typu. Následne sa vám všetci objavia v zozname náhradníkov. Tu im opäť treba nastaviť prioritu. Ten s najvyššou
                    ...
                    <br><br><br>
                    <h1><c1> Vymeniť hráča vo všetkých formáciách </c1></h1> 
                    Je nová funkcia <a href="https://www.hockeyarena.net/sk/index.php?p=public_shop.php">sponzorského balíka</a>. V detaile/editore <a href="https://www.hockeyarena.net/sk/index.php?p=manager_lines_detail_form_new.inc&line_id=5194782">formácie</a> je odteraz možná automatická výmena zvoleného hráča vo všetkých formáciách v ktorých sa nachádza. Táto funkcia značne zjednoduší prácu napríklad pri nahradení hráča, ktorý odišiel z mužstva a nachádzal sa vo viacerých formáciách. Funkcia sa zapína aktiváciou zaškrtávacieho políčka <u>“Vymeniť vo všetkých formáciách”</u>. Systém zobrazí aj informáciu o všetkých formáciách v ktorých sa hráč nachádza.
                    <br>
                    <b>UPOZORNENIE – pri tejto funkcii treba dávať obzvlášť pozor, nakoľko ak má manažér vytvorených viacero formácií s tými istými hráčmi ale rôznymi taktikami, tak hráči budú automaticky vymenení aj v neaktívnych formáciách. Taktiež bude vo všetkých formáciách znížená aktuálna <a href="https://wiki.hockeyarena.net/index.php?navod=zohranost_formacie.html">zohranosť</a> formácií. </b> 
