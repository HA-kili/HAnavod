            ...
            <ul id="rout">
                ...
                <li><a data-submenu="submsys" class=" dropdown-btn " onclick="return false;" href="index.php?navod=system_ligy">Systém ligy, turnajov, repre </a>
                    <ul class="sub submsys <?php active(explode(",", "system_ligy,system_turnajov,system_repre"))?>">
                        ...
                        <li><a class="level1" href="index.php?navod=system_repre">Systém repre</a></li>
                    </ul>
                </li>
                ...
                <li><a data-submenu="submB" class=" dropdown-btn " onclick="return false;" href="index.php?navod=b_muzstvo"> B / U23 / repre </a>
                ...
                <li><a data-submenu="submother" class=" dropdown-btn " onclick="return false;" href="index.php?navod=narocnost_ligy">Rôzne</a>
                    <ul class="sub  submother <?php active(explode(",", "narocnost_ligy,nastavenie_zapasu,stavkova_kancelaria,posta,doplnky_(addons),skratky"))?>">
                        ...
                        <li><a class="level1" href="index.php?navod=doplnky_(addons)">Doplnky (addons) </a></li>
